...
function SignupForm({ onSubmit }: { onSubmit: (e: FormEvent<HTMLFormElement>) => void }) {
  ...
  return <form className="form-grid" onSubmit={onSubmit}>
    ...
    {isVet ? <>
      <label className="full">Veterinary practice name<small>This determines which work orders and dashboard records the account can access.</small><input name="practiceName" required /></label>
